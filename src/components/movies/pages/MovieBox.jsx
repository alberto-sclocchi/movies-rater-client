  ...
  return (
     <div className={renderType === RenderType.addedMovie ? 'searched-movie added-movie' : 'searched-movie'}>
        <div className='movie-box-buttons'>
          ...
          {renderType === RenderType.addedMovie  && <span className="index-span" style={{backgroundColor : index === 0 ? "gold" : index === 1 ? "silver" : index === 2 ? "#cd7f32" : "rgb(220, 38, 38)"}}>{index + 1}</span>}
          {
            isAlreadyAdded
            ? <p>Already Added</p>
